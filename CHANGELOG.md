...
## 2.21.0 - Nova 2. Delivery 48 (December 19, 2024)
### What's changed
* LT-5940: Update refit to 8.x version.
* LT-5885: Keep schema for appsettings.json up to date.
* LT-5872: Keep schema for appsettings.json up to date.
